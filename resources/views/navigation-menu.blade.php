            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->email === config('portfolio.admin_email'))
                        <x-nav-link href="{{ route('portfolio-admin.index') }}" :active="request()->routeIs('portfolio-admin.*')">
                            {{ __('Portfolio Admin') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                @if (Auth::user()->email === config('portfolio.admin_email'))
                    <x-responsive-nav-link href="{{ route('portfolio-admin.index') }}" :active="request()->routeIs('portfolio-admin.*')">
                        {{ __('Portfolio Admin') }}
                    </x-responsive-nav-link>
                @endif
